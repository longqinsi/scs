...
namespace Hik.Collections
{
    ...
    internal sealed class BiDictionary<TKey, TValue> : IDictionary<TKey, TValue>
    {
        #region Fields
        ...
        public bool RemoveByKey(TKey key)
        {
            ...
            Contract.Assert(wasKeyRemoved && wasValueRemoved);
        ...
        public bool RemoveByValue(TValue value)
        {
            ...
            bool wasValueRemoved = valuesToKeys.Remove(value);
            bool wasKeyRemoved = keysToValues.Remove(key);
            Contract.Assert(wasValueRemoved && wasKeyRemoved);
        ...
        public void SetValue(TKey key, TValue value)
        {
            ...
            if (valuesToKeys.TryGetValue(value, out clashingKey))
            {
                ...
                string message = string.Format("Cannot assign value {0} to key {1}, that value is already in use by key {2}.", value, key, clashingKey);
        ...
        public void SetKey(TValue value, TKey key)
        {
            ...
            if (keysToValues.TryGetValue(key, out clashingValue))
            {
                ...
                string message = string.Format("Cannot assign key {0} to value {1}, that key is already in use by value {2}.", key, value, clashingValue);
                throw new ArgumentException(message);
            }
        ...
        {
            Contract.Invariant(keysToValues.Count == valuesToKeys.Count);
        }
        #endregion
