...
namespace Hik.Communication.Scs.Communication.Protocols.BinarySerialization
{
    ...
    public class BinarySerializationProtocol : IScsWireProtocol
    {
        ...
        {
            /// <summary>
            /// Implements BindToType
            /// </summary>
            /// <param name="assemblyName">The full name of the assmebly that the type of the object to be serialized belongs to.</param>
            /// <param name="typeName">The full name of the type of the object to be serialized.</param>
            /// <returns>The type to serialize to.</returns>
